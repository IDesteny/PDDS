...
auto BenchmarkStack(int n, int mn, int mx)
{
	std::vector<int64_t> t(10);
...
int main()
{
	...
	cout << "+----------+------------+-------------+-----------+----------+--------------+-------------+-------------+" << endl;
	cout << "|   name   | list(func) | list(class) | list(std) | set(std) |  stack(std)  |   fastest   |   slowest   |" << endl;
	cout << "+----------+------------+-------------+-----------+----------+--------------+-------------+-------------+" << endl;
